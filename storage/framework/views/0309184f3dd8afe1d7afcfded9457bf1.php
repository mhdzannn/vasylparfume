...
<?php $__env->startSection('judul', 'Hubungi'); ?>
          ...
          <div class="col-sm-2 g-2">
            <div class="card">
              <div class="card-body">
                ...
                <img src="<?php echo e(asset('assets/instagram2.jpg')); ?>" class="d-block w-100" alt="parfume image"  style="width: 150px; object-fit:cover;">
          ...
          <div class="col-sm-2 g-2">  
            <div class="card">
              <div class="card-body">
                ...
                <img src="<?php echo e(asset('assets/wa1.png')); ?>" class="d-block w-100" alt="parfume image"  style="width: 150px; object-fit:cover;">
          ...
          <div class="col-sm-2 g-2">
            <div class="card">
              <div class="card-body">
                ...
                <img src="<?php echo e(asset('assets/email1.jpg')); ?>" class="d-block w-100" alt="parfume image"  style="width: 150px; object-fit:cover;">
...
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\website-fauzan\resources\views/contact.blade.php ENDPATH**/ ?>