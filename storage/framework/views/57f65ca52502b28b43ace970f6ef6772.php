...
<?php $__env->startSection('judul', 'Tentang'); ?>
...
<!--Div Pertama-->
  ...
  <div class="row g-0">
    <div class="col-md-4">
      <img src="<?php echo e(asset('assets/Logo1.jpg')); ?>" class="img-fluid" alt="...">
    </div>
    <div class="col-md-8">
      <div class="card-body">
...
<div class=" row justify-content-center">
      <div class="row text-dark mt-4">
            <div class="col-sm-4 g-4">
              <div class="card">
                <div class="card-body">
                  <img src="<?php echo e(asset('assets/A1.jpeg')); ?>" class="d-block w-100" alt="parfume image"  style="height: 320px;">
                </div>
              </div>
            </div>
            <div class="col-sm-4 g-4">  
              <div class="card">
                <div class="card-body">
                  <img src="<?php echo e(asset('assets/A2.jpeg')); ?>" class="d-block w-100" alt="parfume image"  style="height: 320px;">
                </div>
              </div>
            </div>
            <div class="col-sm-4 g-4">
              <div class="card">
                <div class="card-body">
                  <img src="<?php echo e(asset('assets/A3.jpeg')); ?>" class="d-block w-100" alt="parfume image"  style="height: 320px;">
                  </div>
                </div>
              </div>
          </div>
...
<div class=" row justify-content-center">
  <div class="row text-dark mt-4">
        <div class="col-sm-4 g-4">
          <div class="card">
            <div class="card-body">
              <img src="<?php echo e(asset('assets/gambar10.jpeg')); ?>" class="d-block w-100" alt="parfume image"  style="height: 320px;">
            </div>
          </div>
        </div>
        <div class="col-sm-4 g-4">  
          <div class="card">
            <div class="card-body">
              <img src="<?php echo e(asset('assets/gambar12.jpeg')); ?>" class="d-block w-100" alt="parfume image"  style="height: 320px;">
            </div>
          </div>
        </div>
        <div class="col-sm-4 g-4">
          <div class="card">
            <div class="card-body">
              <img src="<?php echo e(asset('assets/gambar11.jpeg')); ?>" class="d-block w-100" alt="parfume image"  style="height: 320px;">
              </div>
            </div>
          </div>
      </div>
...
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\website-fauzan\resources\views/about.blade.php ENDPATH**/ ?>