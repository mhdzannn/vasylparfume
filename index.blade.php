...
<div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="{{asset('assets/Gambar1.jpg')}}" class="d-block w-100" alt="parfume image"  style="height: auto;">
      ...
      <div class="carousel-item">
        <img src="{{asset('assets/Gambar2.jpg')}}" class="d-block w-100" alt="parfume image"  style="height: auto;">
        <div class="carousel-caption" style="color: black;">
          <h5>VASYL PARFUME</h5>
      ...
      <div class="carousel-item">
        <img src="{{asset('assets/Gambar3.jpg')}}" class="d-block w-100" alt="parfume image"  style="height: auto;">
        <div class="carousel-caption" style="color: black;">
          <h5>VASYL PARFUME</h5>
          <p>Parfume & Men's cologne</p>
        </div>
    ...
    <div class="col-sm-3 g-3">
      <div class="card">
        <div class="card-body">
          ...
          <img src="{{asset('assets/g1.jpeg')}}" class="d-block w-100" alt="parfume image"  style="width: 150px; object-fit:cover;">
    ...
    <div class="col-sm-3 g-3">  
      <div class="card">
        <div class="card-body">
          ...
          <img src="{{asset('assets/g2.jpeg')}}" class="d-block w-100" alt="parfume image"  style="width: 150px; object-fit:cover;">
          <a href="https://instagram.com/Vasylparfume" class="btn btn-dark d-block">SHOP NOW</a>
        </div>
      </div>
    </div>
    <div class="col-sm-3 g-3">
      <div class="card">
        <div class="card-body">
          ...
          <img src="{{asset('assets/g3.jpeg')}}" class="d-block w-100" alt="parfume image"  style="width: 150px; object-fit:cover;">
          <a href="https://instagram.com/Vasylparfume" class="btn btn-dark d-block">SHOP NOW</a>
          </div>
        </div>
      </div>
    ...
    <div class="col-sm-3 g-3">
      <div class="card">
        <div class="card-body">
          ...
          <img src="{{asset('assets/Feed 3.jpg')}}" class="d-block w-100" alt="parfume image"  style="width: 150px; object-fit:cover;">
          <a href="https://instagram.com/Vasylparfume" class="btn btn-dark d-block">SHOP NOW</a>
        </div>
      </div>
    </div>
