...
<div class=" row justify-content-center">
  <div class="row text-dark mt-4">
        <div class="col-sm-4 g-4">
          <div class="card">
            <div class="card-body">
              <img src="{{asset('assets/gambar10.jpeg')}}" class="d-block w-100" alt="parfume image"  style="height: 320px;">
            </div>
          </div>
        </div>
        <div class="col-sm-4 g-4">  
          <div class="card">
            <div class="card-body">
              <img src="{{asset('assets/gambar12.jpeg')}}" class="d-block w-100" alt="parfume image"  style="height: 320px;">
            </div>
          </div>
        </div>
        <div class="col-sm-4 g-4">
          <div class="card">
            <div class="card-body">
              <img src="{{asset('assets/gambar11.jpeg')}}" class="d-block w-100" alt="parfume image"  style="height: 320px;">
              </div>
            </div>
          </div>
      </div>
